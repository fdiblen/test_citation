...
git branch -M main
git remote add origin git@github.com:fdiblen/test_citation
```
...
and create a new repository named `test_citation` as an empty repository, then push your commits to GitHub:
...
automatically ([here](https://github.com/fdiblen/test_citation/issues?q=author%3Aapp%2Fgithub-actions)). Resolve them to complete the
